...
export const AnalysisSchema = z.object({
  ...
  mercados_sugeridos: z.array(z.object({ mercado: z.string(), seleccion: z.string(), razonamiento: z.string(), nivel_riesgo: z.enum(["Bajo", "Medio", "Alto"]), confianza: confidence, requiere_revision: z.boolean() })),
