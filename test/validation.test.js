...
test("acepta todas las nuevas competiciones confirmadas sin el límite artificial de siete", () => {
  const slugs = ["mls", "brasileirao-serie-a", "liga-profesional-argentina", "liga-mx-femenil", "liga-expansion-mx", "eredivisie", "allsvenskan", "eliteserien", "conmebol-libertadores", "conmebol-sudamericana", "uefa-champions-league", "uefa-champions-qualifying", "uefa-europa-qualifying", "uefa-conference-qualifying"];
