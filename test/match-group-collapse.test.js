...
test("cada competición muestra y abre hasta dos orígenes líderes", () => {
  assert.match(app, /const currentMonthHistory = currentMonthPerformanceData\(\)/);
  assert.match(app, /calculateCompetitionOriginLeaders\(currentMonthHistory\.picks, currentMonthHistory\.parlays/);
